---
description: Run the 'implement' workflow as defined in .ai/workflows/implement.md
---

Read `.ai/workflows/implement.md` and execute it for the topic/feature provided in the user's message.
