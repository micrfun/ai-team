---
description: Run the 'plan' workflow as defined in .ai/workflows/plan.md
---

Read `.ai/workflows/plan.md` and execute it for the topic/feature provided in the user's message.
