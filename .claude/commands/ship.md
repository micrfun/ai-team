---
description: Run the 'ship' workflow as defined in .ai/workflows/ship.md
---

Read `.ai/workflows/ship.md` and execute it for the topic/feature provided in the user's message.
